...
import Autocomplete from "../components/good/downshift-autocomplete"
...
[Test example](https://github.com/marcysutton/js-a11y-workshop/tree/master/src/components/good/__tests__)
...
# _No matter what kind of test you’re writing, focus on the outcome, not the implementation_ ✨
...
# Write a combination<br />of tests to catch a variety<br />of bugs 💻🔎🐛
