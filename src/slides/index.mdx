...
- Also: slides with vanilla.js demos
...
# Web accessibility<br />in the wild

- [Slack file viewer](https://gatsbyjs.slack.com/files/U964CL6GZ/FKPT589U4/feedback-with-comments.json?origin_team=T6VN36NMP)
...
Use your preferred JavaScript libraries
...
# A sad reality
People often think visible focus styles are a bug. Tools for mitigating:
...
_An OS-level preference would be ideal!_ 👍
...
Cached class names aren't human friendly, e.g. `class="sc-bdVaJa"`
...
`
const Layout = () => (
    <MegaHeader className={`site-wrap`}>  {/* add a stable CSS class */}
